...
export const saveByExcel = (listData) => {
    let Stringxls =
        `MSSV , Họ tên ,
         Điểm hệ 10 , Điểm hệ 4, Điểm tích lũy 10 , Ngành , Khoa , Ngày sinh , lớp \n `;
    listData.forEach((element) => {
        Stringxls += `
        ${element.id} , ${element.fullname} , ${element.diemhe10} , ${element.diemhe3} , ${element.tichLuy10} , ${element.tichLuy4} , ${element.tinChiTichLuy} , ${element.major} , 
${element.faculty} , 
${element.birth} , 
${element.class}  \n  `;
    });
